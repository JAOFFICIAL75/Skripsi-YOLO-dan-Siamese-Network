...
#inference_model.load_weights(r"C:\Users\Asus\.atom\databaru_v2\SiamesePerson_CNN_Lab1A_contrastiveloss_02.h5")


cap = cv2.VideoCapture(r"Video Testing\testing1.mp4")
#cap = cv2.VideoCapture(r"C:\Users\Asus\.atom\Manajemen Karyawan\walking1.mp4")
...
# pengumpulan data
simpan_warna = {"Azizah":(34, 34, 178), "Rizki":(0, 215, 255), "Zidan":(34, 139, 34)}
nama_track_tersimpan = {"Azizah":cv2.imread("Azizah.jpg"),
                        "Rizki":cv2.imread("Rizki.jpg"),
                        "Zidan":cv2.imread("Zidan.jpg")}
#simpan_warna = {}
...
while True:
    ...
    if pos_frame%10 == 0:
        ...
        #cv2.putText(img, "Jumlah : "+str(len(indices)), (40, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 255), 3)
        ...
        #cv2.imwrite(f"Hasil Realtime/{int(pos_frame):04d}.jpg",image)
